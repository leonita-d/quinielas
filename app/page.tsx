...
export default function QuinielaPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-6 px-3 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-8 text-center space-y-2">
          <p className="text-slate-400 text-xs md:text-sm">
            <span className="text-emerald-400 font-semibold">Última actualización:</span> {data?.consultado || "---"}
          </p>
          {data?.fechaAyer && (
            <p className="text-emerald-400 text-xs md:text-sm font-semibold">Nocturna del: {data.fechaAyer}</p>
          )}
          <p className="text-slate-400 text-xs md:text-sm">
            Datos extraídos de{" "}
            <a
