...
function DigitalClock() {
  ...
  return (
    <div className="bg-blue-950 border-4 border-blue-900 rounded-xl px-6 md:px-8 py-3 md:py-4 shadow-2xl">
      <div className="text-blue-100 font-black text-4xl md:text-5xl drop-shadow-lg font-mono tracking-wider">
        {time || "00:00:00"}
      </div>
    </div>
  )
...
export function SidebarPanel({ fecha }: SidebarPanelProps) {
  ...
  return (
    <div className="relative h-full min-h-[500px] rounded-2xl overflow-hidden flex flex-col items-center justify-start pt-8 px-6 shadow-2xl border-4 border-emerald-300 bg-gradient-to-b from-emerald-50 via-green-100 to-emerald-200">
      ...
      <div className="relative z-10 text-center w-full">
        <div className="flex flex-col items-center gap-2 mb-8">
          <h2 className="text-2xl md:text-3xl font-black text-emerald-900 drop-shadow">
            Cabezas del día
          </h2>
          <DigitalClock />
        </div>
        ...
        <div className="space-y-8">
          <div>
            <p 
              ...
              className="text-emerald-900 font-black text-5xl md:text-5xl mb-3 tracking-wider drop-shadow">EL NUMERAZO</p>
            <input
              type="text"
              value={numerazo}
              ...
              style={{
                textShadow: "0 0 10px rgba(255,255,255,0.8), 0 0 20px rgba(255,255,255,0.5), 0 0 30px rgba(255,255,255,0.3)",
                caretColor: focusedInput === "numerazo" ? "auto" : "transparent"
              }}
              className="text-7xl md:text-8xl font-black text-blue-950 drop-shadow-2xl bg-transparent border-none text-center w-full outline-none px-2 py-2"
            />
          </div>
          ...
          <div>
            <p 
              ...
              className="text-emerald-900 font-black text-5xl md:text-5xl mb-3 tracking-wider drop-shadow">LA FIJA</p>
            <input
              type="text"
              value={laFija}
              ...
              className="text-6xl md:text-7xl font-black text-blue-950 drop-shadow-2xl bg-transparent border-none text-center w-full outline-none px-2 py-2"
            />
          </div>
          ...
          <div>
            <p 
              ...
              className="text-emerald-900 font-black text-5xl md:text-5xl mb-3 tracking-wider drop-shadow">EL ESPECIAL</p>
            <input
              type="text"
              value={elEspecial}
              ...
              style={{
                textShadow: "0 0 10px rgba(255,255,255,0.8), 0 0 20px rgba(255,255,255,0.5), 0 0 30px rgba(255,255,255,0.3)",
                caretColor: focusedInput === "elEspecial" ? "auto" : "transparent"
              }}
              className="text-6xl md:text-7xl font-black text-blue-950 drop-shadow-2xl bg-transparent border-none text-center w-full outline-none px-2 py-2"
            />
          </div>
